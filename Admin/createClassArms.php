...
<?php include 'includes/title.php';?>
  ...
  <script>
    function classArmDropdown(str) {
      if (str == "") {
          document.getElementById("classArmSelect").innerHTML = "";
          return;
      } else { 
          ...
          xmlhttp.open("GET","getClassArms.php?cid="+str,true);
          xmlhttp.send();
      }
    }
  </script>
                ...
                <div class="card-body">
                  <form method="post">
                    <div class="form-group row mb-3">
                        ...
                        <input type="text" class="form-control" required name="classArmName" placeholder="Enter Class Section Name">
                        </div>
                    </div>
                      <?php
                    if (isset($Id))
