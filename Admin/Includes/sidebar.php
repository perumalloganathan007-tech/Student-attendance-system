     ...
     <li class="nav-item">
         ...
         <div id="collapseBootstrapassests" class="collapse" aria-labelledby="headingBootstrap" data-parent="#accordionSidebar">
             <div class="bg-white py-2 collapse-inner rounded">
                 ...
                 <h6 class="collapse-header mt-3">Subject Teachers</h6>
                 <a class="collapse-item" href="createSubjects.php">Create Subjects</a>
                 <a class="collapse-item" href="createSubjectTeacher.php">Create Subject Teachers</a>
                 <a class="collapse-item" href="assignStudentsToSubject.php">Assign Students</a>
             </div>
         </div>
     </li>
     <!-- <li class="nav-item">
